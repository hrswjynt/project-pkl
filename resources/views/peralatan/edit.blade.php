                    ...
                    <form action="{{ url('peralatan/' . $tool->id) }}" method="post">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="jenis" class="form-control @error('jenis') is-invalid @enderror"
                                value="{{ old('jenis', $jenis->jenis) }}" autofocus>
                            @error('jenis')
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="merk" class="form-control @error('merk') is-invalid @enderror"
                                value="{{ old('merk', $merk->merk) }}" autofocus>
                            @error('merk')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
                        ...
                        <div class="form-group">
                            <label>Seri</label>
                            <input name="seri" class="form-control @error('seri') is-invalid @enderror"
                                value="{{ old('seri', $seri->seri) }}">
                            @error('seri')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
